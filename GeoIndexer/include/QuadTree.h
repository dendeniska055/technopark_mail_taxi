...
namespace Geo {
        ...
        public:
            QuadTreeObjectMover(std::stack<QuadTreeNode<DataType, LockType> *> callStack,
                                const QuadTreeNode<DataType, LockType> *root,
                                size_t deep);
            QuadTreeObjectMover(QuadTreeObjectMover<DataType, LockType>&& other) noexcept;
            QuadTreeObjectMover(const QuadTreeObjectMover<DataType, LockType>& other) = default;
    ...
    template<typename DataType, typename LockType>
    QuadTreeObjectMover<DataType, LockType>::QuadTreeObjectMover(
            QuadTreeObjectMover<DataType, LockType> &&other) noexcept
    {
                std::cout << other.callStack.top()->GetQuadrant();
    ...
    template<typename DataType, typename LockType>
        ...
        QuadTreeObjectMover<DataType, LockType> QuadTree<DataType, LockType>::UpdateAndGetMover(Coordinate coordinate,
            ...
            QuadTreeNode<DataType, LockType> * test = callStack.top();
            auto temp = QuadTreeObjectMover<DataType, LockType>(std::move(callStack), root, deep);
            return temp;
        }
